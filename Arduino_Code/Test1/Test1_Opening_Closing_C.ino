...
// --- TEST 1 COMPLIANT SETTINGS (10% INCREMENTS) ---
const int CLOSE_SPEED = 2000;
const int OPEN_SPEED = 970;

// Adjust times so 10 steps correspond to full opening
const int STEP_TIME_CLOSE = 800;
const int STEP_TIME_OPEN = 800;
...
void loop() {
  if (Serial.available() > 0) {
    ...
    // 5. RETURN TO MANUAL MODE (Joystick)
    else if (cmd == 'j' || cmd == 'J') {
      manualMode = true;
